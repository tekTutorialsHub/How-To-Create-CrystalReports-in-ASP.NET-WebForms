...
namespace CrWebFormsApp.CustomerTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Northwind].[dbo].[Customers] WHERE (([CustomerID] = ?))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Northwind].[dbo].[Customers] ([CustomerID], [CompanyName], [ContactN" +
                "ame], [ContactTitle], [Address], [City], [Region], [PostalCode], [Country], [Pho" +
                "ne], [Fax]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Northwind].[dbo].[Customers] SET [CustomerID] = ?, [CompanyName] = ?, [Co" +
                "ntactName] = ?, [ContactTitle] = ?, [Address] = ?, [City] = ?, [Region] = ?, [Po" +
                "stalCode] = ?, [Country] = ?, [Phone] = ?, [Fax] = ? WHERE (([CustomerID] = ?))";
        ...
        public virtual int Fill(Customer.CustomersDataTable dataTable) {
        ...
        public virtual Customer.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Customer.CustomersDataTable dataTable = new Customer.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Customer.CustomersDataTable dataTable) {
